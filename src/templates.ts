...
export const templates: TemplateProps[] = [
  ...
  },
  {
    ...
    dependencies: 'express cors',
    devDependencies: 'typescript ts-node-dev @types/cors @types/node @types/express ',
  },
  {
    template: 'node-express-js',
    description: 'API with ExpressJS + JavaScript + ESLint + Prettier',
    dependencies: 'cookie-parser dotenv express express-async-errors helmet morgan ejs',
    devDependencies:
  ...
  },
  {
    ...
    description: 'API with ExpressJS + TypeScript + ESLint + Prettier + Jest and Husky with Lint-Staged',
    dependencies:
  ...
  },
  {
    ...
    devDependencies: 'nodemon typescript @types/express @types/node @swc/cli @swc/core',
  },
];
